...
class SEARAgent:
    ...
    def __init__(self, obs_shape, action_shape, device, lr, latent_dim,
        ...
        self.mask_enc_opt = torch.optim.Adam(mask_params,
                                        lr=mask_lr)
    ...
    def update_critic_and_decoders(self, encoded_obs, action, reward,
    ...
    def update(self, replay_iter, step):
        ...
        metrics.update(
            self.update_critic_and_decoders(encoded_obs, action,
