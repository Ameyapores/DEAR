...
import utils
from environments import dmc
from environments.adroit_dm_env import make_adroit
from environments.distracting_dmc import make_distracting_dmc
from environments.kitchen_dm_env import make_kitchen
from environments.metaworld_dm_env import make_metaworld
from logger import Logger
from replay_buffer_with_ted import ReplayBufferStorage, make_replay_loader
...
def make_env(cfg, is_eval):
    if cfg.task_name.split("_", 1)[0] == "metaworld":
        ...
        env = dmc.make(cfg.task_name, cfg.frame_stack, cfg.action_repeat,
                       cfg.seed, cfg.add_segmentation_to_obs)
    return env
...
class Workspace:
    ...
    def __init__(self, cfg):
        ...
        self.replay_loader = make_replay_loader(
            ...
            self.cfg.has_success_metric, self.cfg.ted)
...
def main(cfg):
    ...
    from train_ted import Workspace as W
